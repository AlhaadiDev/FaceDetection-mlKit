...
//        canvas.drawText(
//                "getHeadEulerAngleZ: " + String.format("%.2f", face.getHeadEulerAngleZ()),
//                x + ID_X_OFFSET,
//                y - ID_Y_OFFSET,
//                idPaint);
//
//        canvas.drawText(
//                "getHeadEulerAngleY: " + String.format("%.2f", face.getHeadEulerAngleY()),
//                x + ID_X_OFFSET,
//                y - ID_Y_OFFSET,
//                idPaint);
...
//                    canvas.drawText(
//                "leftEarPos: " + String.format("%.2f", leftEarPos),
//                x + ID_X_OFFSET,
//                y - ID_Y_OFFSET,
//                idPaint);
//        }
